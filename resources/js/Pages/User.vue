...
<template>
    ...
    <MainLayout>
        <div class="pt-2 md:pt-6">
            <div class="max-w-[880px] lg:ml-0 md:ml-[88px] md:pl-20 px-4 w-[100vw]">
                <div class="flex items-center md:justify-between">
                    <label for="fileUser">
                        <img :src="user.file" class="rounded-full object-fit md:w-[200px] w-[100px] cursor-pointer" alt="">
                        <input type="file" id="fileUser" class="hidden" @input="getUploadedImage($event)"
                        ...
                        <div class="ml-6 w-full">
                            ...
                            <div class="md:block hidden">
                                <div class="flex items-center text-[18px]">
                                    ...
                                    <div class="mr-6">
                                        <span class="font-extrabold">120</span> following
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="md:hidden">
            <div class="w-full flex items-center justify-around border-t border-t-gray-300 mt-8">
               <div class="text-center p-3">
                ...
                <div class="text-center p-3">
                    <div class="font-extrabold">45</div>
            ...
            <div class="w-full flex items-center justify-between border-t border-t-gray-300">
                <div class="p-3 w-1/4 flex justify-center border-t border-t-gray-900">
                    <Grid :size="28" fill-color="#0095F6" class="cursor-pointer"/>
                </div>

                <div class="p-3 w-1/4 flex justify-center">
                    <PlayBoxOutline :size="28" fill-color="#8E8E8E" class="cursor-pointer"/>
                </div>

                <div class="p-3 w-1/4 flex justify-center">
                    <BookmarkOutline :size="28" fill-color="#8E8E8E" class="cursor-pointer"/>
                </div>

                <div class="p-3 w-1/4 flex justify-center">
                    <AccountBoxOutline :size="28" fill-color="#8E8E8E" class="cursor-pointer"/>
                </div>
            </div>
        </div>
        ...
        <div id="ContentSection" class="md:pr-1.5 lg:pl-0 md:pl-[90px]">
            ...
            <div class="grid md:gap-4 gap-1 grid-cols-3 relative">
                <div v-for="postByUser in postsByUser.data" :key="postByUser">
                    <ContentOverlay :postByUser="postByUser" @selectPost="data.post = $event"/>
                </div>
            </div>
            <div class="pb-20"></div>
        </div>
